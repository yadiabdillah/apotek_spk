            ...
            <div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
                <div class="widget-box" id="widget-box-1">
                    <div class="widget-header">
                        <h5 class="widget-title">Daftar User</h5>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="center col-lg-2">Nama</th>
                                <th>Username</th>
                                <th>Email</th>
                                <th>Jabatan</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons center">
                                        <a class="blue" href="<?php echo base_url()?>index.php/User/reset_pass/<?php echo  $r->id; ?>">
                                            <i class="ace-icon glyphicon glyphicon-refresh bigger-120"></i>
                                        </a>
                                        <a class="green" href="<?php echo base_url()?>index.php/User/edit/<?php echo  $r->id; ?>">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>
                                        <?php
                                        if($r->jabatan=='Super Admin'){
                                        ?>
                                        <a class="red" href="javascript:" onclick="jvnotif()" >
                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                        </a>
                                        <?php
                                        } else {
                                        ?>
                                        <a class="red" href="javascript:" onclick="jvDelete('<?php echo  $r->id; ?>')" >
                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                        </a>
                                        <?php
                                        }
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                ...
                                                <li>
                                                    <a href="<?php echo base_url()?>index.php/user/delete/" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
                ...
                <p>
                    <a href="#my-modal" role="button" class="btn btn-white btn-default  btn-round col-sm-12" data-toggle="modal">
                        <i class="ace-icon fa fa-plus green"></i>&nbsp; Tambah user baru &nbsp;
                    </a>
                </p>
            </div>
            ...
            <div id="my-modal" class="modal fade" tabindex="-1">
                ...
                <script type="text/javascript">
                            jQuery(function($) {
                                ...
                                function jvnotif(){
                                alert("Maaf Super Admin tidak bisa di hapus!!")
                                }
                                </script>