                ...
                <div class="widget-box transparent" id="widget-box-12">
                    ...
                    <div class="widget-body">
                        <div class="widget-main padding-6 no-padding-left no-padding-right">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url()?>index.php/Pasien/edit">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ID Pasien </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="id_pasien" readonly="" id="form-field-1" value="<?php echo $record['id_pasien']; ?>" placeholder="" class="col-xs-10 col-sm-5" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Pasien </label>
                                    <div class="col-sm-9">
                                        <input type="text"name="nama_pasien" required="" id="form-field-1" value="<?php echo $record['nama_pasien']; ?>" placeholder="Null" class="col-xs-10 col-sm-5" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                       <select class="col-xs-10 col-sm-5" name="tipe_pasien" >
                                            <option value="BPJS"<?php if ($record['tipe_pasien']=='BPJS') {
                                                echo "selected";
                                            } ?>>BPJS   </option>
                                            <option value="Umum" <?php if ($record['tipe_pasien']=='Umum') {
                                                echo "selected";
                                            } ?>>Umum   </option>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah data Pasien</h3>
                        </div>
                        <div class="modal-body">
                            <form method="POST" class="form-horizontal" action="<?php echo base_url()?>index.php/Pasien/view" role="form">
                                
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ID Pasien </label>
                                    <div class="col-sm-9">
                                        <input type="text" id="form-field-1" name="id_pasien" placeholder="ID Pasien" class="col-xs-10 col-sm-5" />
                                    </div>
                                </div>
                                <div class="form-group">
